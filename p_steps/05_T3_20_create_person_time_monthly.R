##%######################################################%##
#                                                          #
####         COUNT GENERAL MONTHLY PERSON-TIME          ####
#                                                          #
##%######################################################%##
...
for (subpop in subpopulations_non_empty) {  
  ...
  #                             type_outcome = c(OUTCOME_variables), meaning_renamed = "DO NOT USE",
  ...
  not_recurrent_OUTCOME_variables <- setdiff(c(OUTCOME_variables), recurrent_OUTCOME_variables)
